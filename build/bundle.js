	...
	var Counter = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(Count, { count: this.state.counter }),
	            React.createElement(IncrementButton, { increment: this.incrementCounter }),
	            React.createElement(DecrementButton, { decrement: this.decrementCounter })
	        );
	    }
